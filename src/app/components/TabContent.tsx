...
import { FaFolder, FaFileExcel, FaFilePowerpoint, FaFileWord, FaFileImage, FaFileCode, FaCopy, FaCut, FaPaste, FaTrash, FaEdit, FaFolderPlus, FaCog, FaArrowLeft, FaArrowRight, FaArrowUp, FaSearch, FaThLarge, FaBars, FaHdd, FaCompactDisc, FaNetworkWired, FaMusic, FaVideo } from 'react-icons/fa';
...
export const TabContent: React.FC<TabContentProps> = ({ tabId, isActive, viewMode, setViewMode }) => {
    // Sample files and folders for each tab
                    ...
                    <div className={`file-list ${viewMode}`}>
                        ...
                        <div className="file-items">
                            {fileItems.map((item, index) => (
                                <div key={`${tabId}-${index}`} className="file-item">
